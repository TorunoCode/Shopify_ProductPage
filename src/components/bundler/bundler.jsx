...
const bundler = () => {
  ...
  const toggleBundler = (index) => {
    setActiveOption(index);
    globalConfig.publish({ activeOption: index });
  };

  return (
    <div className="product_selector-content">
      <div className="product-selector_outer">
        <div
          className={
            activeOption === 0
              ? "product-selector_block active"
              : "product-selector_block"
          }
          onClick={() => toggleBundler(0)}
        >
          <div className="product-selector_head">
            <div>
              <div className="product-selector_bubble">
                <div className="product-selector_bubble_inn"></div>
              </div>
            </div>
            <div>
              <p className="product-selector_title">1 Bottle</p>

              <p className="product-selector_info">
                1 bottle total | Save $27.99
              </p>
            </div>
            <div>
              <p className="product-selector_price">$31.96</p>
              <s className="product-selector_compare">$59.95</s>
            </div>
          </div>
          <div className="product-selector_perks">
            <div className="product-selector_perk_line">
              <div>
                <img src="//trysculptique.com/cdn/shop/files/delivery-truck_181581.png?v=1749555916" />
              </div>
              <div>
                <p>
                  <span className="kaching-bundles__free-gift__text">
                    Free USA Shipping
                  </span>
                </p>
              </div>
        ...
        >
          ...
          <div className="product-selector_head">
            ...
            <div>
              <p className="product-selector_title">Buy 2 Get 1 Free</p>

              <p className="product-selector_info">
                3 bottles total | Save $115.93
              </p>
            </div>
            <div>
              <p className="product-selector_price">$63.92</p>
              <s className="product-selector_compare">$179.85</s>
            </div>
          </div>
          <div className="product-selector_perks">
            <div className="product-selector_perk_line">
        ...
        >
          <div className="product-selector_head">
            ...
            <div>
              <p className="product-selector_title">Buy 3 Get 2 Free</p>

              <p className="product-selector_info">
                5 bottles total | Save $203.87
              </p>
            </div>
            <div>
              <p className="product-selector_price">$95.88</p>
              <s className="product-selector_compare">$299.75</s>
            </div>
          </div>
          <div className="product-selector_perks">
            <div className="product-selector_perk_line">
        ...
        <input type="radio" name="plan" value="1-bottle" />
        <div className="card-content">
          <div className="main-info">
            <div className="plan-details">
              <span className="bottle-count">1 Bottle</span>
              <span className="savings">1 bottle total | Save $27.99</span>
            </div>
            <div className="price-box">
              <span className="current-price">$31.96</span>
              <span className="old-price">$59.95</span>
            </div>
          </div>
          <div className="product-selector_perks d-flex flex-column">
            <div className="shipping-banner">Free USA Shipping</div>
          </div>
        </div>
      </label> */}
      </div>
